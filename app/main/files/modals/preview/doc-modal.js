<<<<<<< HEAD
angular.module('web')
  .controller('docModalCtrl', ['$scope','$uibModalInstance','Const','bucketInfo','objectInfo', 'showFn', 'ossSvs2','fileType',
    function ($scope, $modalInstance, Const, bucketInfo, objectInfo, showFn, ossSvs2, fileType) {
